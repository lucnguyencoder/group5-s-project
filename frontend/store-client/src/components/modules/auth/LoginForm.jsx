...
const LoginForm = () => {
  ...
  return (
    <AuthenticateLayout>
      <SetTitle title={"Sign In to Yami Partner Portal"} />
      ...
      <CardContent className="space-y-4">
        <Alert variant="default">
          <AlertCircleIcon />
          <AlertTitle>Sign in with partner account</AlertTitle>
          <AlertDescription>
            <p>
              To sign in to the Partner Portal, use an provided partner account
              from the system or your store manager.
            </p>
          </AlertDescription>
        </Alert>
